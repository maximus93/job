...
<html lang="en">
  ...
  <body>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <div class="banner-heading" style="font-size:25px;font-weight:300;color:#fff;">Candidates Details</div>    
                            </div>  
                        </div>
                    </div>
                </div>
    ...
    text-align: center;
    margin-right: 20px;"><img src="<?php echo base_url();?>images/candidate-6.png" alt="" class="img-responsive"></div>
    ...
    line-height: 35px;
    font-weight: 700;
    margin-top:-10px;"><u>Homer Simpson</u></h1>
								<ul class="unstyled" style="margin-top:-25px;padding: 0px;">
									<li style="display: inline-block;
    padding: 0 50px 0 0;
    color: #7d7d7d;
    font-size: 13px;"> Toulouse, France</li>
								</ul>
								<p></p>
							</div>
						</div>
							<div class="col-md-12">
								...
								<li><strong style="color: #237fa5;">Accounting Manager</strong></li>
								</div>
								<div class="contact_details col-md-8 col-sm-8 p-l">
								<span class="col-md-8">
									<strong  style="float:left;margin-left:-15px;font-size: 12px; padding-bottom:5px;" class="col-md-12">US:</strong>
									<strong  style="float:left;margin-left:-15px;font-size: 12px; padding-bottom:5px;" class="col-md-12">Home:</strong>
									<strong  style="float:left;margin-left:-15px;font-size: 12px; padding-bottom:5px;" class="col-md-12">Mobile:</strong>
								</span>
								<span class="col-md-4">
								</span>
								</div>
    ...
    overflow: hidden;">
						...
						<div class="col-md-3">
							<div class="col-md-12" style="padding:20px;"><button class="btn btn-primary" style="background:#5cc069;border:1px solid #5cc069;">Send Messages</button></div>
							<div class="col-md-12">
							<a href="#"><p style="color:#237fa5;font-size:13px;" class="col-md-12"><strong><u>Add to Folder</u></strong></p></a>
							<a href="#"><p style="color:#237fa5;font-size:13px;margin-top:-10px;" class="col-md-12"><strong><u>Print</u></strong></p></a>
							<a href="#"><p style="color:#237fa5;font-size:13px;margin-top:-10px;" class="col-md-12"><strong><u>Forward resume</u></strong></p></a>
							<a href="#"><p style="color:#237fa5;font-size:13px;margin-top:-10px;" class="col-md-12"><strong><u>Add note </u></strong></p></a>
							<a href="#"><p style="color:#237fa5;font-size:13px;margin-top:-10px;" class="col-md-12"><strong><u>Compare to other Candidates</u></strong></p></a>
							</div>
						</div>
  ...
  <ul class="nav nav-tabs" style="border:1px solid #1c4972;background:#1c4972;">
    <li class="active"><a href="#home" style="border:none;">Resume Upload</a></li>
    <li><a href="#menu1" style="border:none;">Candidate Detail</a></li>
    <li><a href="#menu2" style="border:none;">Additional Info</a></li>
  ...
  <div class="tab-content" style="padding-bottom:15px;">
    <div id="home" class="tab-pane fade in active">
	  <div class="col-md-6">
      <p style="font-size:13px;"><strong>Resume Upload</strong></p>
      <p style="font-size:13px;"><strong>Resume Download</strong></p>
	  </div>
	  <div class="col-md-6">
	   <p style="font-size:13px;"><strong>2 Months Ago</strong></p>
      <p><button class="btn btn-primary btn-xs">Download</button></p>
	  </div>
	  <hr>
	  <div class="col-md-12" style="border:1px solid #e1e1e1;padding-top:20px;padding-left:30px;margin-top:20px;">
		...
		<p style="font-size:13px;margin-top:-5px;">Accounting Manager</strong></p>
		<p style="font-size:13px;margin-top:-5px;">Wonderlust Finanace Corporation Private Limited</p>
		<p style="font-size:13px;margin-top:-5px;">Pin - 700122</p>
		<p style="font-size:13px;margin-top:-5px;">HSimpson@gmail.com</p>

		<br>

		<p><u><strong>KEY SKILLS</strong></u></p>
		<ul>
			<li>Accounting.</li>
			<li>Administration & Office Support.</li>
    ...
    <div id="menu1" class="tab-pane fade">
      <p><strong>Homer Simpson</strong></p>
		...
		<!-- <p><strong style="font-size:15px;">CANDIDATE NAME</strong></p> -->
		<p style="font-size:13px;margin-top:-5px;">Accounting Manager</strong></p>
		<p style="font-size:13px;margin-top:-5px;">SN Banerjee Road, Barrackpore,Pin - 700122</p>
		<p style="font-size:13px;margin-top:-5px;"></p>
		<p style="font-size:13px;margin-top:-5px;">HSimpson@gmail.com</p>
	...
	<div class="col-md-12" style="border:1px solid #e1e1e1;">
      <div class="col-md-6" style="padding-top:10px;">
		<p style="font-size:13px;"><strong>First Name</strong></p>
		<p style="font-size:13px;"><strong>Last Name</strong></p>
		<p style="font-size:13px;"><strong>Father Name</strong></p>
		<p style="font-size:13px;"><strong>Mother Name</strong></p>
		<p style="font-size:13px;"><strong>School</strong></p>
		<p style="font-size:13px;"><strong>College</strong></p>
		<p style="font-size:13px;"><strong>University</strong></p>
	  </div>
	  <div class="col-md-6" style="text-align:center;padding-top:10px;" >
		<p style="font-size:13px;">Homer</p>
		<p style="font-size:13px;">Simpson</p>
		<p style="font-size:13px;">Gerrard Simpson</p>
		<p style="font-size:13px;">Kathlin Simpson</p>
		<p style="font-size:13px;">Douglas International School</p>
		<p style="font-size:13px;">Kathlin Simpson</p>
		<p style="font-size:13px;">Cambridge University</p>
	  </div>
	  </div>
    </div>
